...
% tle = tleread("GOES18TLE.txt")
% mu_e = 398600;
% r_e = 6378; % km 
% % T = (2*pi/sqrt(mu_e))*orb.a^(3/2)
% 
% n = tle.MeanMotion
% n = deg2rad(n)
% T = 2*pi/n
...
xlabel('x [km]')
ylabel('y [km]')
title("rho (ECI) hop 100-40")
axis("equal")
scatter(0,0)

figure(100)
hold on 
plot(t,vecnorm(R,2,2))
