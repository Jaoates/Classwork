...
% ����������������
%
% This functionsolves Example 10.2 by using Encke's method together
...
t= t0;
%Initialize the time scalar
tsave= t0;
%Initialize the vector of solution times
y= [R0 V0];
%Initialize the state vector
del_y0 = zeros(6,1);
%Initialize the state vector perturbation
t = t + del_t;
%First time step
