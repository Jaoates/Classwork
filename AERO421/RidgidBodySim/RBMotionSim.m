...
%psi: column matrix containing the different values of the Euler angle psi over time over
%theta: column matrix containing the different values of the Euler angle theta over time
%phi: column matrix containing the different values of the Euler angle phi over time
