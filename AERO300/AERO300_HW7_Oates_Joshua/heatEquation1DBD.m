...
function [x, t, w] = heatEquation1DBD(D, f, l, r, xdom, tdom, M, N)
% Solves the 1D heat equation in a bar using the Backward Difference Method
...
for j=1:N-1
    ...
    w(j+1,2:m+1) = A\(wj + sj); %Can also use Jacobi or Gauss-Seidel interation since A is strictly row diagonally dominant
end
end