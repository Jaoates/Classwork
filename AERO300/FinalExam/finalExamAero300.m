...
ylabel("advection")
legend("0",".5","1","1.5","5")
disp("It looks as though the diffusivity issue is solved for most values less than T=5. at T=5 it is much reduced from the previous scheme. This is obvious whe comparing figures 2 and 3 since the amplitude in figure 3 does not noticably change over time until T=5. This is very distinct from figure 4.")
