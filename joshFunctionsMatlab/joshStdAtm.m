function [T,P,rho,mu] = joshStdAtm(h)
...
arguments
    h double{mustBeReal} = 0
end

if h<0
    warning("joshStdAtm:Negativeh - the h you have entered is negative, joshStdAtm will return a value as if h is 0m.")
    h = 0;
end
if h>100000
    warning("joshStdAtm:hTooLarge - the h you have entered is too large, joshStdAtm will return a value as if h is 100000m.")
    h = 100000;
end
