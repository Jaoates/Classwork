###########################################################################
## Makefile generated for component 'Week4'. 
## 
## Makefile     : Week4.mk
## Generated on : Mon Oct 10 10:00:40 2022
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Week4.elf
...
SLIB_PATH                 = C:/Users/Josh2/DOCUME~1/MATLAB/R2022a/ARDUIN~1/ARDUIN~1/FASTER~1
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Week4.elf
...
DEFINES_CUSTOM = 
DEFINES_OPTS = -DXCP_EXTMODE_SIMULATION_TIME_IN_TICKS -DXCP_DAQ_SUPPORT -DXCP_CALIBRATION_SUPPORT -DXCP_TIMESTAMP_SUPPORT -DXCP_TIMESTAMP_BASED_ON_SIMULATION_TIME -DXCP_SET_MTA_SUPPORT -DXCP_MEM_DAQ_RESERVED_POOLS_NUMBER=1 -DEXTMODE_XCP_TRIGGER_SUPPORT -DEXTMODE_STATIC -DEXTMODE_STATIC_SIZE=2048 -DON_TARGET_WAIT_FOR_START=1 -DTID01EQ=0 -DXCP_MEM_BLOCK_1_SIZE=8 -DXCP_MEM_BLOCK_1_NUMBER=1 -DXCP_MEM_BLOCK_2_SIZE=32 -DXCP_MEM_BLOCK_2_NUMBER=1 -DXCP_MEM_BLOCK_3_SIZE=48 -DXCP_MEM_BLOCK_3_NUMBER=1
...
DEFINES_STANDARD = -DMODEL=Week4 -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_Ultrasonic.o xcp_ext_mode.o Week4.o Week4_data.o xcp_ext_common.o xcp_ext_classic_trigger.o xcp.o xcp_standard.o xcp_daq.o xcp_calibration.o xcp_fifo.o xcp_transport.o xcp_mem_default.o xcp_drv_rtiostream.o xcp_frame_serial.o xcp_ext_param_default_serial.o MW_ArduinoHWInit.o io_wrappers.o arduinoAVRScheduler.o rtiostream_serial_daemon.o
...
%.o : $(START_DIR)/Week4_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/Week4_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
MW_Ultrasonic.o : C:/ProgramData/MATLAB/SupportPackages/R2022a/toolbox/target/supportpackages/arduinobase/src/MW_Ultrasonic.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


Week4.o : $(START_DIR)/Week4_ert_rtw/Week4.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Week4_data.o : $(START_DIR)/Week4_ert_rtw/Week4_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/Week4_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"
